...
function c44460068.matfilter(c)
	return c:IsSetCard(0x64b) and c:IsSetCard(0x64c)  and c:IsAbleToGraveAsCost()
end
function c44460068.spfilter1(c,tp)
	return c:IsFaceup() and c:IsSetCard(0x64b) and c:IsAbleToGraveAsCost()
		and Duel.IsExistingMatchingCard(c44460068.spfilter2,tp,LOCATION_SZONE,0,1,c)
end
function c44460068.spfilter2(c)
	return c:IsFaceup() and c:IsSetCard(0x64c) and c:IsAbleToGraveAsCost()
end
