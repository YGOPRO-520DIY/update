...
function c44460052.xytg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return tc:IsSetCard(0x64a) and tc:GetControler()==tp
...
function c44460052.cfilter(c,tc)
	return c:IsSetCard(0x64a) and not c:IsCode(tc:GetCode()) and c:IsType(TYPE_MONSTER) and c:IsAbleToGrave()
end
