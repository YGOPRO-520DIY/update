...
function c600048.cfilter(c,tp)
	return c:IsSetCard(0x3515) and c:IsLocation(LOCATION_HAND) and c:IsAbleToGraveAsCost()
...
function c600048.filter1(c,code)
	return c:IsType(TYPE_MONSTER) and c:IsSetCard(0x3515) and not c:IsCode(code) and c:IsAbleToHand()
end
...
function c600048.thfilter(c)
	return c:IsSetCard(0x3515) and c:IsAbleToHand()
end
