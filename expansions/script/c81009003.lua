...
function c81009003.initial_effect(c)
	...
	e1:SetCondition(c81009003.condition)
	e1:SetTarget(c81009003.target)
	e1:SetOperation(c81009003.activate)
	c:RegisterEffect(e1)
end
function c81009003.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c81009003.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local opt=Duel.SelectOption(1-tp,aux.Stringid(81009003,0),aux.Stringid(81009003,1))
	if opt==1 then
