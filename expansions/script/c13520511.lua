local m=13520511
local list={13520510,13520530,13520501,13520502,13520503}
local cm=_G["c"..m]
cm.name="血式少女 鹤王子"
function cm.initial_effect(c)
	...
	e1:SetCategory(CATEGORY_LVCHANGE+CATEGORY_SUMMON+CATEGORY_TOHAND+CATEGORY_SEARCH)
...
function cm.sumfilter(c)
	return cm.isset(c) and c:IsSummonable(true,nil)
end
...
function cm.plop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.CheckLPCost(tp,2*cost) and Duel.IsExistingMatchingCard(cm.sumfilter,tp,LOCATION_HAND,0,1,nil) then
		table.insert(t,2)
	end
