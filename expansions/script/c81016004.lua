...
function c81016004.tg(e,c)
	return c:GetSummonLocation()==LOCATION_EXTRA
end
function c81016004.atkvala(e,c)
	return Duel.GetFieldGroupCount(e:GetHandlerPlayer(),LOCATION_EXTRA,0)*-200
end
function c81016004.atkvalb(e,c)
	return Duel.GetFieldGroupCount(e:GetHandlerPlayer(),0,LOCATION_EXTRA)*-200
end
