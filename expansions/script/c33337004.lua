...
function cm.splimit(e,c,sump,sumtype,sumpos,targetp,se)
	return not c:IsSetCard(0x333a)
end
function cm.spfilter(c,e,tp,ec)
	return c:IsSetCard(0x333a) and c:IsCanBeSpecialSummoned(e,SUMMON_TYPE_LINK,tp,false,false) and c:IsType(TYPE_LINK) and c:IsLinkBelow(2)
