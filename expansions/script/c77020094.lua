...
function cm.initial_effect(c)
	--synchro summon
	aux.AddSynchroProcedure(c,aux.FilterBoolFunction(Card.IsSetCard,0x3ee3),aux.NonTuner(nil),1)
	c:EnableReviveLimit()
	--banish
...
function cm.cfilter(c)
	return c:IsSetCard(0x3ee3) and c:IsType(TYPE_MONSTER) and c:IsAbleToRemoveAsCost()
end
...
function cm.thfilter(c)
	return c:IsSetCard(0x3ee3) and c:IsAbleToHand()
end
