...
function c40009029.initial_effect(c)
	...
	e1:SetTarget(c40009029.target)
	e1:SetOperation(c40009029.operation)
	c:RegisterEffect(e1)
end
...
function c40009029.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c40009029.operation(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
