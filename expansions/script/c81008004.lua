...
function c81008004.initial_effect(c)
	...
	e5:SetCountLimit(1,81008004)
	e5:SetCondition(c81008004.atkcon)
	e5:SetOperation(c81008004.atkop)
	c:RegisterEffect(e5)
end
...
function c81008004.atkcon(e,tp,eg,ep,ev,re,r,rp)
...
function c81008004.atkop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
