...
function cm.drawtg(e,tp,eg,ep,ev,re,r,rp,chk)
  ...
  Duel.Hint(HINT_MESSAGE,1-e:GetHandlerPlayer(),aux.Stringid(31420008,0))
end
...
function cm.sertg(e,tp,eg,ep,ev,re,r,rp,chk)
  ...
  Duel.Hint(HINT_MESSAGE,1-e:GetHandlerPlayer(),aux.Stringid(31420008,2))
end
...
function cm.spstg(e,tp,eg,ep,ev,re,r,rp,chk)
  ...
  Duel.Hint(HINT_MESSAGE,1-e:GetHandlerPlayer(),aux.Stringid(31420008,3))
end
