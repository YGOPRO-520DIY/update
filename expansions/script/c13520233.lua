...
function cm.ritual_filter(c)
	return c:IsType(TYPE_RITUAL) and c:IsRace(RACE_PLANT)
end
--To Deck
function cm.tdfilter(c)
	return cm.flower(c) and c:IsType(TYPE_MONSTER) and bit.band(c:GetReason(),REASON_RELEASE)~=0 and c:IsAbleToDeck()
end
