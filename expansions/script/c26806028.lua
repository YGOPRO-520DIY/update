...
function c26806028.initial_effect(c)
	c:EnableReviveLimit()
	aux.AddLinkProcedure(c,c26806028.matfilter,3,99,c26806028.lcheck)
	--damage
	...
	e0:SetCondition(c26806028.condition)
...
function c26806028.matfilter(c)
...
function c26806028.cfilter(c)
	return c:IsFaceup() and c:IsCode(26806009)
end
function c26806028.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c26806028.cfilter,tp,LOCATION_ONFIELD,0,1,nil)
end
...
function c26806028.damop(e,tp,eg,ep,ev,re,r,rp)
	if not Duel.IsExistingMatchingCard(c26806028.cfilter,tp,LOCATION_ONFIELD,0,1,nil) then return end
