...
function cm.filter(c,e,tp)
	return c:IsSetCard(0x3ee3) and c:IsType(TYPE_MONSTER) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function cm.dbfilter(c)
	return c:IsFaceup() and c:IsSetCard(0x3ee3) and c:GetFlagEffect(m)==0
end
