--风纪委员·冴岛清美
function c81007057.initial_effect(c)
	--negate
	...
	e1:SetCountLimit(1,81007057)
	e1:SetCondition(c81007057.discon)
	e1:SetCost(c81007057.discost)
	e1:SetTarget(c81007057.distg)
	e1:SetOperation(c81007057.disop)
	c:RegisterEffect(e1)
end
function c81007057.discon(e,tp,eg,ep,ev,re,r,rp)
...
function c81007057.discost(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return c:IsDiscardable() end
	Duel.SendtoGrave(c,REASON_COST+REASON_DISCARD)
end
function c81007057.distg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	Duel.SetOperationInfo(0,CATEGORY_NEGATE,eg,1,0,0)
end
function c81007057.disop(e,tp,eg,ep,ev,re,r,rp)
