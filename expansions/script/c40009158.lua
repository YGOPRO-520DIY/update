...
function c40009158.thfilter(c)
	return c:IsSetCard(0xf28) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand() and not c:IsCode(40009158)
end
...
function c40009158.spfilter(c,e,tp)
	return c:IsSetCard(0xf28) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
