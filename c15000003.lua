...
function cm.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(15000003,1))  
	e2:SetCategory(CATEGORY_SPECIAL_SUMMON)  
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)  
	e2:SetProperty(EFFECT_FLAG_DELAY)  
	e2:SetCode(EVENT_TO_GRAVE)  
	e2:SetCountLimit(1,15010003)  
	e2:SetCondition(c15000003.spcon)  
	e2:SetTarget(c15000003.sptg)  
	e2:SetOperation(c15000003.spop)  
	c:RegisterEffect(e2)
end
